...
**
** Created: Thu 23. Jul 15:12:35 2009
**      by: The Qt Meta Object Compiler version 61 (Qt 4.5.2)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "B:/eventdialog.h"
...
static const char qt_meta_stringdata_EventDialog[] = {
    "EventDialog\0\0index\0"
    "on_cbAction_currentIndexChanged(int)\0"
};

const QMetaObject EventDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_EventDialog,
      qt_meta_data_EventDialog, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_EventDialog))
...
int EventDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_cbAction_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
